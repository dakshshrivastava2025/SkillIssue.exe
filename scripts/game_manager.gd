...
func load_room(index: int) -> void:
	...
	var ai = get_node_or_null("/root/AIDirector")
	if ai:
		ai.set("current_room", index + 1)

	var hud = get_node_or_null("/root/Main/DirectorHUD")
	if hud and hud.has_method("update_status_text"):
		var room_titles = [
			"ROOM 1 — THE CRYPT | CLEAR ALL FOES",
			"ROOM 2 — THE ICY VAULT | DEFEAT THE HORDE",
			"ROOM 3 — SPEED SANCTUM | SURVIVE THE ASSAULT",
			"ROOM 4 — THE DIRECTOR'S LAB | INVERTED TRIALS",
			"ROOM 5 — DARK WIZARD'S LAIR | DEFEAT THE BOSS"
		]
		if index < room_titles.size():
			hud.update_status_text(room_titles[index])

	print("[GameManager] Room %d loaded: %s" % [index, path])

func _find_room_path(index: int) -> String:
	var options: Array[Array] = [
		["res://scenes/enemies/room_1_tutorial.tscn", "res://Scenes/enemies/room_1_tutorial.tscn", "res://scenes/rooms/Room1_Tutorial.tscn"],
		["res://scenes/enemies/room_2_icy.tscn", "res://Scenes/enemies/room_2_icy.tscn", "res://scenes/rooms/Room2_IcyFloor.tscn"],
		["res://scenes/enemies/room_3_faster.tscn", "res://Scenes/enemies/room_3_faster.tscn", "res://scenes/rooms/Room3_FasterEnemies.tscn"],
		["res://scenes/enemies/room_4_director.tscn", "res://Scenes/enemies/room_4_director.tscn", "res://scenes/rooms/Room4_Director.tscn"],
		["res://scenes/enemies/room_5_boss.tscn", "res://Scenes/enemies/room_5_boss.tscn", "res://scenes/rooms/Room5_Boss.tscn"],
	]
